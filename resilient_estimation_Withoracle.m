function R = resilient_estimation_Withoracle(m,n,Pa,Tr)
% function R = resilient_estimation_Withprior(m,n,Pa)
% Description:
%             This function is evaluate the performance of resilient
%             estimation with Pruning Algorithm, if estimate error is 
%             larger than 1%*x0, the estimation fails, otherwise it successes.
%      inputs:
...
for i = 1:tot  
    ...
    e(i) =  Weighted_L1_solver(H,y,x0,q_hat);
end
